...
In order to allow application-specific user and lab group data, SLIMcore Authorizer adds 
two models to your application, UserProfile and LabGroupProfile. This plugin/engine 
